...
//        	startGame();
        ...
        waitingToPlay = new JLabel("Waiting for host to begin game...");
        waitingToPlay.setFont(new Font("Comic Sans MS", Font.PLAIN, 30));
...
//		}
	...
	/**
	 * Sets the waiting message and start button visibility to false and sets playing to true.
	 */
